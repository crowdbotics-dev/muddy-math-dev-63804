"""
Django settings for muddy_math_dev_63804 project.
...
ROOT_URLCONF = 'muddy_math_dev_63804.urls'
...
WSGI_APPLICATION = 'muddy_math_dev_63804.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_math_dev_63804 API",
    "DESCRIPTION": "API documentation for muddy_math_dev_63804 App",
    "VERSION": "v1",
}
